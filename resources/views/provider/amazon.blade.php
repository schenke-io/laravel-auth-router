<x-auth-router::login-button :route="route($provider->loginRoute)" :text="__('auth-router::login.amazon')">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" class="amazon-logo">
        <path fill="#FFB300"
